    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-[2000px] mx-auto p-2 mx-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mb-4">
          ...
          <Card className="bg-white border-slate-200 shadow-lg h-[570px] rounded-lg border border-slate-300">
          ...
          <Card className="bg-white border-slate-200 shadow-lg h-[570px] flex flex-col rounded-lg border border-slate-300">
            <CardHeader className="pb-4 bg-slate-800 border-b border-slate-700">
              <CardTitle className="text-white text-lg flex items-center gap-2">
                <Plus size={18} />
